...
export function RegionFilterFallback() {
  return (
    <div className="mt-16 flex flex-col">
      <div className="flex w-full animate-pulse cursor-not-allowed justify-center rounded-full border-1 border-neutral-300 bg-neutral-300 px-5 py-3 font-medium text-transparent">
        placeholder
      </div>
      <div className="mt-5 flex w-full animate-pulse cursor-not-allowed justify-center rounded-full border-1 border-neutral-300 bg-neutral-300 px-5 py-3 font-medium text-transparent">
        placeholder
      </div>
    </div>
  )
