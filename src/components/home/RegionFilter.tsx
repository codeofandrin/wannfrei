...
export function RegionFilterFallback() {
  return (
    <div className="mt-16 flex flex-col sm:mt-32 sm:flex-row sm:items-center sm:justify-center">
      <div className="flex w-full animate-pulse cursor-not-allowed justify-center rounded-full border-1 border-neutral-300 bg-neutral-300 px-5 py-3 font-medium text-transparent sm:w-68 sm:py-2">
        placeholder
      </div>
      <div className="mt-5 flex w-full animate-pulse cursor-not-allowed justify-center rounded-full border-1 border-neutral-300 bg-neutral-300 px-5 py-3 font-medium text-transparent sm:mt-0 sm:ml-5 sm:w-56 sm:py-2">
        placeholder
      </div>
    </div>
  )
