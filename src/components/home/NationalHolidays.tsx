import { getNationalHolidays } from "@/lib/api"
import { getHolidayRowsData } from "@/utils/helpers"

import Holidays from "./Holidays"

interface NationalHolidaysPropsType {
  year: string | null
}

export default async function NationalHolidays({ year }: NationalHolidaysPropsType) {
